...
var isFunction = require('../type-checkers/is-string.js');
var isString = require('../type-checkers/is-string.js');
...
AuthClient.prototype._makeRequest = function ( ) {
  ...
  this._authClient.request(
    ...
    , function ( err, result, response ) {
      ...
      if ( err ) {
        console.log("REQUEST ATTEMPT COMPLETED WITH ERROR", err);
...
AuthClient.prototype._pauseForClientInitialization = function ( ) {
  ...
  setTimeout(
    this._queueNextRequest.bind(this)
    , 1500
  );
}
...
AuthClient.prototype.sendError = function ( err, callback ) {
  ...
  console.log("\n\nGot a request to report errors!\n\n");
