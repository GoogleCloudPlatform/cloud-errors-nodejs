...
function extractServiceContext(initConfiguration) {
  ...
  if (has(initConfiguration, 'serviceContext') &&
      isPlainObject(initConfiguration.serviceContext)) {
 ...
 * @property {Boolean} reportUncaughtExceptions=true - the flag denoting
 *  whether or not to catch and report uncaught errors to the API
...
function gatherConfiguration(initConfiguration) {
  ...
  var projectId = null;
  var reportUncaughtExceptions = true;
  ...
  if (isPlainObject(initConfiguration)) {
    ...
    if (has(initConfiguration, 'reportUncaughtExceptions')) {

      reportUncaughtExceptions = !!initConfiguration.reportUncaughtExceptions;
    }
