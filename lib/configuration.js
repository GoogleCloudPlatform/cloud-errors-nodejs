 ...
 *  onUncaughtException=uncaughtHandlingEnum.report - the flag denoting how to
...
function gatherConfiguration(initConfiguration) {
  ...
  var projectId = null;
  var onUncaughtException = uncaughtHandlingOptions.report;
  ...
  if (env.NODE_ENV === 'production') {
    ...
    console.log([
      ...
      '\'production\'. To enabling logging of errors to the StackDriver API',
