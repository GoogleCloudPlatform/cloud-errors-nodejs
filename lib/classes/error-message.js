...
var isNumber = require('../type-checkers/is-number.js');
var isObject = require('../type-checkers/is-object.js');
...
ErrorMessage.prototype.setLineNumber = function ( lineNumber ) {
  ...
  this.context.reportLocation.lineNumber = isNumber(lineNumber) ? lineNumber : 0;
